...
int main(void) {
    ...
    *puntero_int = 57;
    printf("\nEl nuevo valor de la variable int es: %d\n", *puntero_int);
    ...
    *puntero_char = 'eiii';
    printf("\nEl nuevo valor de la variable char es: %c\n", *puntero_char);
    ...
    *puntero_float = 17;
    printf("\nEl nuevo valor de la variable float es: %0.2f\n", *puntero_float);
    ...
    *puntero_double = 77;
    printf("\nEl nuevo valor de la variable double es: %f\n", *puntero_double);
